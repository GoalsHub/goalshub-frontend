...
class StagesControllerTest < ActionController::TestCase
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post :create, stage: { description: @stage.description, name: @stage.name, plan_id: @stage.plan_id, user_id: @stage.user_id }
    end
  ...
  test "should update stage" do
    patch :update, id: @stage, stage: { description: @stage.description, name: @stage.name, plan_id: @stage.plan_id, user_id: @stage.user_id }
    assert_redirected_to stage_path(assigns(:stage))
  end
